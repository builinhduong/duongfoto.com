...
// Định nghĩa interface Photo trực tiếp trong file này
interface Photo {
  src: string;
  title?: string;
  description?: string;
...
interface OptimizedBentoGalleryProps {
  images: Photo[]
}

export function OptimizedBentoGallery({ images }: OptimizedBentoGalleryProps) {
