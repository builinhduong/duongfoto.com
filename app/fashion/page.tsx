...
export default function FashionPage() {
  // Đọc danh sách các dự án từ thư mục data/fashion (ngoại trừ file index.json)
  const projectsDirectory = path.join(process.cwd(), "data/fashion");
  ...
  return (
    <div className="container mx-auto py-10">
      <h1 className="text-4xl font-bold mb-8">FASHION</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project) => (
          <Link
            key={project.id}
            href={`/fashion/${project.id}`}
